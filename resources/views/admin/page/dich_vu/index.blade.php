                            ...
                            <template v-for="(v, k) in list_dich_vu">
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <img v-bind:src="v.hinh_anh" class="rounded-circle p-1 border" width="180px" height="180px">
                                    </td>
                                    ...
                                    <td class="text-center align-middle">
                                        <i v-on:click="tt_xoa = v" data-bs-toggle="modal" data-bs-target="#detailModal" class="text-success fa-solid fa-circle-info fa-2x"></i>
                                    </td>
                                    <td class="text-center align-middle">
                                        <button v-on:click="doiTrangThai(v)" v-if="v.tinh_trang" class="btn btn-primary">Đang Kinh Doanh</button>
                                        <button v-on:click="doiTrangThai(v)" v-else class="btn btn-warning">Dừng Kinh Doanh</button>
                                    </td>
                                    <td class="text-center align-middle">
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <label class="mb-2">Tên Dịch Vụ</label>
                                <input v-model="tt_cap_nhat.ten_dich_vu" type="text" class="form-control mb-2" placeholder="Nhập vào tên dịch vụ">
                                <label class="mb-2">Mô Tả</label>
                                <textarea v-model="tt_cap_nhat.mo_ta" cols="30" rows="5" class="form-control mb-2"></textarea>
                                <label class="mb-2">Giá Bán</label>
                                <input v-model="tt_cap_nhat.gia_ban" type="number" class="form-control mb-2" placeholder="Nhập vào giá bán">
                                <label class="mb-2">Hình Ảnh</label>
									...
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											...
											<p class="text-wrap">Bạn có chắc muốn xóa dịch vụ
                                                ...
                                                với giá
                                                <span class="text-danger"><b>"@{{ format(tt_xoa.gia_ban) }}" này không?!</b></span>
                                            </p>
										</div>
									</div>
